      ...
      <div className="min-h-screen text-white flex items-center justify-center p-4">
        <div className="bg-[#111111] border border-gray-800 rounded-xl p-8 max-w-md w-full">
          ...
          <form action="/admin" method="GET">
            <input type="password" name="password" placeholder="Введите пароль" className="w-full px-4 py-2 rounded-lg bg-[#1A1A1A] 
              border border-gray-700 text-white mb-4 focus:outline-none focus:ring-2 focus:ring-purple-600"/>
