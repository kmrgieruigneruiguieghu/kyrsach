...
export default function HowItWorksPage() {
  ...
  return (
    <div className="relative z-10">
      <section className="pt-24 pb-16 md:pt-32 md:pb-20 border-b border-gray-800">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto">
            От загрузки данных до готового резюме — всего несколько минут. 
            AI делает всю сложную работу за тебя, а ты получаешь результат, который выделяется среди сотен кандидатов.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20 border-b border-gray-800">
        <div className="container mx-auto px-4">
          ...
          <p className="text-gray-400 text-center max-w-2xl mx-auto mb-12">
            ProfResume не просто оформляет — он делает твоё резюме эффективным
          </p>
          <div className="max-w-3xl mx-auto">
            <Carousel items={carouselItems} autoPlayInterval={10000} />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20 border-b border-gray-800">
        <div className="container mx-auto px-4">
          ...
          <p className="text-gray-400 text-center max-w-2xl mx-auto mb-12">
            Посмотри, как AI улучшает твоё резюме
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-[#111111] border border-gray-800 rounded-xl p-6">
              ...
              <p className="text-gray-400 italic mb-3">
                «Занимался разработкой, писал код, работал в команде»
              </p>
            ...
            <div className="bg-[#111111] border border-purple-600/50 rounded-xl p-6 relative min-h-70">
              <div className="absolute -top-3 left-4 bg-purple-600 text-xs px-2 py-0.5 rounded-full">
                AI улучшил
              </div>
              <div className="flex items-center gap-2 mb-4">
      ...
      <section className="py-16 md:py-20 border-b border-gray-800">
        <div className="container mx-auto px-4">
          ...
          <p className="text-gray-400 text-center max-w-2xl mx-auto mb-12">
            Введите данные и посмотрите, как AI улучшает резюме
          </p>
        ...
        <div className="container mx-auto px-4 max-w-md">
          <div className="bg-[#111111] border border-gray-800 rounded-xl p-8 text-center">
            ...
            <p className="text-gray-400 mb-6">
              Получи ранний доступ и бонус — скидка 50% + 30 дней бесплатного полного доступа
            </p>
            <Link
              href="/"
              className="inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 
              rounded-lg font-medium transition">
              Вернуться на главную и зарегистрироваться
