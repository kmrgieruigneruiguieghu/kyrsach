...
import { features, steps, plans, faqs } from "@/components/ui/dataarray"
...
export default function Home() {
  ...
  return (
    <div className="relative z-10">
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4 sm:px-0">
            <button
              ...
              className="bg-purple-600 hover:bg-purple-700 text-white px-6 sm:px-8 py-2.5 sm:py-3 rounded-lg 
              font-medium text-base sm:text-lg transition inline-flex items-center justify-center gap-2">
              Получить ранний доступ
              <ArrowRight className="h-4 w-4 sm:h-5 sm:w-5" />
            </button>
            <Link
              href="/how-it-works"
              className="border border-gray-700 hover:bg-gray-800 text-white px-6 sm:px-8 py-2.5 sm:py-3
              rounded-lg font-medium text-base sm:text-lg transition">
              Подробности работы
            </Link>
          </div>
        </div>
      ...
      <section id="pricing" className="py-20 border-t border-gray-800 bg-[#0A0A0A]">
        <div className="container mx-auto px-4">
        ...
        <div className="container mx-auto px-4 max-w-md">
          <div className="bg-[#111111] border border-gray-800 rounded-xl p-8">
            ...
            <p className="text-gray-400 text-center mb-6">
              Оставь email и получи скидку 50% + 30 дней полного доступа после запуска
            </p>
            {message && (
